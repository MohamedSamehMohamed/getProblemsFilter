...
def get_unsolved_problems(user_handles, min_rate, max_rate, count, tags_to_include, tags_to_exclude, divs_list,
    ...
    try:
        ...
        if data["status"] == "OK":
            ...
            for problem in data["result"]["problems"]:
                ...
                current_problem['link'] = 'https://codeforces.com/problemset/problem/' + str(
